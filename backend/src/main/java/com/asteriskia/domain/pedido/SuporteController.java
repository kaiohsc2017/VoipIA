 ...
 * Cria uma issue real no Jira via JiraIntegrationService. Se o Jira não estiver
 * configurado, retorna erro claro para a IA informar o cliente.
 */
@Slf4j
@RestController
    ...
    public ResponseEntity<Map<String, Object>> abrirProtocolo(@Valid @RequestBody AbrirProtocoloRequest request) {
        ...
        if (issueKey != null) {
            ...
            response.put("mensagem",
                "Protocolo " + issueKey + " aberto com sucesso. "
