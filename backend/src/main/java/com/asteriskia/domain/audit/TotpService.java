 ...
 *
 * Usa HMAC-SHA1 nativo do Java para gerar/validar códigos de 6 dígitos
 * compatíveis com Google Authenticator, Authy e qualquer app TOTP padrão.
 *
 * Segredo armazenado como Base32 (para compatibilidade com QR Codes padrão TOTP).
 */
@Slf4j
@Service
public class TotpService {
    ...
    /**
     * Monta a URL otpauth:// para geração do QR Code.
     * Use um serviço como https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl={url}
     * ou https://api.qrserver.com/v1/create-qr-code/?data={url} para gerar a imagem.
     */
    ...
    /**
     * URL para geração de QR Code via API pública (sem necessidade de lib de QR Code).
     * O frontend exibe essa URL como <img src="..."> para o usuário escanear.
     */
     ...
     * Aceita códigos da janela atual, anterior e posterior (tolerância de ±30s).
     */
    ...
    private int hotp(byte[] key, long counter) throws NoSuchAlgorithmException, InvalidKeyException {
