 ...
 * legíveis (catálogo em AiModelCatalog) 4. Gerenciar a capability chain (STT/LLM/TTS) — leitura e
 * escrita 5. Expor a chain ativa para o ai-agent via endpoint interno
 */
@Slf4j
@Service
