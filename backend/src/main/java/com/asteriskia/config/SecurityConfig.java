    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/phone-numbers/**")
                                .hasAnyAuthority("ROLE_ADMIN", "PERM_READ_telecom.datacenter")
                        ...
                        .requestMatchers("/api/v1/ai/**")
                                .hasAnyAuthority("ROLE_ADMIN", "PERM_WRITE_telecom.settings")
                        .requestMatchers("/api/v1/phone-numbers/**")
                                .hasAnyAuthority("ROLE_ADMIN", "PERM_WRITE_telecom.datacenter")
