...
public class TelegramBotService {
    ...
    public String sendZabbixAlert(String severity, String host, String incidentSummary,
                                   String phoneNumber, String callStatus) {
        ...
        String message = String.format("""
                ...
                """,
                severityEmoji, severity, host, incidentSummary,
                phoneNumber, callStatusEmoji, callStatus,
    ...
    public void sendMessage(String text) {
        ...
        if (botToken.isBlank() || chatId.isBlank()) {
            log.warn("Telegram não configurado — mensagem não enviada (verifique Settings → Telegram)");
            return;
        }
    ...
    private String getSeverityEmoji(String severity) {
        return switch (severity.toLowerCase()) {
            case "disaster" -> "💀"; case "high"    -> "🔴";
            case "average"  -> "🟠"; case "warning" -> "🟡";
            default -> "⚪";
        };
    }
}
