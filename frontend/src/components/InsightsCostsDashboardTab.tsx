...
import type { InsightMonthlyCostSummary } from '../api/types';
...
export function InsightsCostsDashboardTab() {
  ...
  }, [agentNameFilter, dateFrom, dateTo]);
            ...
            <div className="stat-card" style={{ padding: 20 }}>
              ...
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={chartData} margin={{ top: 4, right: 16, left: 0, bottom: 0 }}>
                  ...
                  <Bar dataKey="STT" stackId="cost" fill="#ff9f0a" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          )}
