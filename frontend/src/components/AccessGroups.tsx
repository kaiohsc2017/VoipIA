...
const RESOURCE_CATALOG: { key: string; label: string; system: 'Telecom' | 'Agentes' | 'Insights' | 'Financeiro' | 'Call Center' }[] = [
  ...
  { key: 'financeiro.callcenter_autosservico', label: 'Autosserviço (Base de Conhecimento)', system: 'Financeiro' },
  ...
  { key: 'callcenter.supervisao.redirect', label: 'Redirecionar chamada em fila (sensível)', system: 'Call Center' },
  ...
  { key: 'callcenter.ia_agentes', label: 'Agentes de IA',         system: 'Call Center' },
];
