...
const RESOURCE_CATALOG: { key: string; label: string; system: 'Telecom' | 'Call Center' | 'Insights' | 'Financeiro' | 'Sistema & Governança' }[] = [
  // Telecom
  { key: 'telecom.dashboard',    label: 'Dashboard Geral',         system: 'Telecom' },
  { key: 'telecom.modulo1',      label: 'URA Inteligente',         system: 'Telecom' },
  { key: 'telecom.users',        label: 'Usuários & Ramais',       system: 'Telecom' },

  // Call Center
  { key: 'callcenter.agentes',   label: 'Agentes & Ramais',        system: 'Call Center' },
  { key: 'callcenter.ramais',    label: 'Senha do Ramal (sensível)', system: 'Call Center' },
  { key: 'callcenter.filas',     label: 'Filas de Atendimento',    system: 'Call Center' },
  { key: 'callcenter.skills',    label: 'Habilidades (Skills)',    system: 'Call Center' },
  { key: 'callcenter.wfm',       label: 'WFM & Dimensionamento Erlang-C', system: 'Call Center' },
  { key: 'callcenter.gravacoes', label: 'Gravações & Retenção',    system: 'Call Center' },
  { key: 'callcenter.desktop',   label: 'Desktop do Atendente',    system: 'Call Center' },
  { key: 'callcenter.copilot',   label: 'Copiloto de IA em Tempo Real', system: 'Call Center' },
  { key: 'callcenter.supervisao', label: 'Supervisão em Tempo Real', system: 'Call Center' },
  { key: 'callcenter.supervisao.redirect', label: 'Redirecionar Chamada em Fila', system: 'Call Center' },
  { key: 'callcenter.fluxos',    label: 'Fluxos (Flow Builder)',   system: 'Call Center' },
  { key: 'callcenter.chat',      label: 'Chat Omnichannel',        system: 'Call Center' },
  { key: 'callcenter.kb',        label: 'Base de Conhecimento RAG', system: 'Call Center' },
  { key: 'callcenter.ia_agentes', label: 'Agentes de IA (Prompt/Persona)', system: 'Call Center' },
  { key: 'callcenter.cobrowsing', label: 'Navegação Assistida (Co-Browsing)', system: 'Call Center' },
  { key: 'callcenter.config',    label: 'Pausas & Tabulações',     system: 'Call Center' },

  // Insights
  { key: 'insights.calls',       label: 'Central de Chamadas',     system: 'Insights' },
  { key: 'insights.dashboard',   label: 'Dashboard de Tendências', system: 'Insights' },
  { key: 'insights.processing',  label: 'Processamento de Áudios', system: 'Insights' },
  { key: 'insights.scorecards',  label: 'Fichas de Monitoria',     system: 'Insights' },
  { key: 'insights.reports',     label: 'Relatórios de Atendentes', system: 'Insights' },
  { key: 'insights.uploads',     label: 'Meus Envios (Upload)',    system: 'Insights' },
  { key: 'insights.semantic_search', label: 'Busca Semântica pgvector', system: 'Insights' },

  // Financeiro
  { key: 'financeiro.ura',       label: 'Custos de IA — URA',      system: 'Financeiro' },
  { key: 'financeiro.insights',  label: 'Custos de IA — Insights', system: 'Financeiro' },
  { key: 'financeiro.envios',    label: 'Custos — Análise Sob Demanda', system: 'Financeiro' },
  { key: 'financeiro.callcenter', label: 'Custos — Call Center',   system: 'Financeiro' },
  { key: 'financeiro.callcenter_nps', label: 'Custos — NPS / Satisfação', system: 'Financeiro' },
  { key: 'financeiro.callcenter_autosservico', label: 'Custos — Autosserviço RAG', system: 'Financeiro' },

  // Sistema & Governança
  { key: 'telecom.settings',     label: 'Configurações do Sistema', system: 'Sistema & Governança' },
  { key: 'admin.sso',            label: 'SSO Microsoft Entra ID',  system: 'Sistema & Governança' },
  { key: 'telecom.audit',        label: 'Trilha de Auditoria',     system: 'Sistema & Governança' },
  { key: 'telecom.release',      label: 'Notas de Versão (Release)', system: 'Sistema & Governança' },
];
