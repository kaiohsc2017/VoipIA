/*
 * @rrweb/record v2.1.1 (MIT License) — https://github.com/rrweb-io/rrweb
 * Vendorizado em 2026-08-14 para uso no widget de chat do Call Center (Fase 17b —
 * co-browsing gravado). Build oficial de produção (record.umd.min.cjs), sem modificação de
 * conteúdo além da remoção do comentário sourceMappingURL (mapa não vendorizado).
 * Expõe o global 'rrwebRecord' quando carregado via <script> — usado só a captura (record),
 * nunca o replayer (que fica na aba Gravações do callcenter-platform, Fase 17c).
 */
(function (g, f) {
