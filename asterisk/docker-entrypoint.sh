...
VARS='${AST_AMI_USER}${AST_AMI_PASSWORD}${SIP_TRUNK_HOST}${SIP_TRUNK_FROM_DOMAIN}${SIP_DOMAIN}${SIP_PUBLIC_IP}${INTERNAL_API_KEY}${RAMAL_1001_PASSWORD}${RAMAL_1002_PASSWORD}${RAMAL_9001_PASSWORD}${RAMAL_9002_PASSWORD}'
